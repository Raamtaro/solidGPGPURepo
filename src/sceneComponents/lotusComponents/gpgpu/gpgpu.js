...
class GpgpuComputation {
    ...
    configParticlesVariable() {
        ...
        this.particlesVariable.material.uniforms.uFlowFieldStrength = new THREE.Uniform(.73821)
        this.particlesVariable.material.uniforms.uFlowFieldFrequency = new THREE.Uniform(0.28)
